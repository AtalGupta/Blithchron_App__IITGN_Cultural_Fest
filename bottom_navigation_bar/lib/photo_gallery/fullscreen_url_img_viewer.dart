...
import 'package:bottom_navigation_bar/photo_gallery/app_image2.dart';
import 'package:bottom_navigation_bar/photo_gallery/circle_buttons.dart';
...
class _FullscreenUrlImgViewerState extends State<FullscreenUrlImgViewer> {
  ...
  Widget build(BuildContext context) {
    ...
    content = Semantics(
      ...
      label: 'full screen image, no description available',
      container: true,
      image: true,
