...
class GooeyCarouselState extends State<GooeyCarousel>
  ...
  int _dragIndex = 0; // index of the top child
  ...
  // Size _getSize(ContextAction, builder: context build) {
    
  //   // final box=this.box;
  //   final RenderObject? box = _key.currentContext?.findRenderObject();
  //   // final box = this.box;
  //   // final box=this.box;
  //   if (RenderObject == null) return Size(0, 0);
  //   else {
  //     // var size=box.size;
  //     return box?.size?? Size(0, 0);
  //   }
  // }
